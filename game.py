...
class Game:
    def __init__(self):
        self.screen_main_running = None
        self.original_string = None
        self.user_string = None
        self.screen_running = None
        self.cnt_of_errors = 0
        self.cnt_of_symbols = 0
        self.time = 0
    ...
    def results_screen(self, screen, colors, fonts):
        ...
        while self.screen_running:
            ...
            text8 = fonts["system_50"].render("Most of all you made a mistake in these keys:", True,
                                              colors["black"])
            text9 = fonts["system_50"].render(errors, True, colors["black"])
